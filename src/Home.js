    ...
    <>
        ...
        <div className="filter-box">
          <select
            ...
            style={{
              ...
              backgroundImage: isDarkMode
                ? "url(https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRH9LDU05RrJNzpNY6ZndzAqRuWyk7Xx8S30c3oLPS8Wg&s)"
      ...
      <div className="items-container" style={searchBarStyles}>
        {countryData.map((country) => (
          <Link to={`/countryinfo/${country.name}`} key={country.name}>
            <div
              className="country"
              key={country.name}
              style={{
